...
print ("<FORM action='preference.html' method='post'>")

# パラメータエラー時の対応 
if form_check == 1 :
  print ("<h2>Missing info!</h2>")
  print("Please try again by using Back Button, or ")
  print("<a href='http://www.tokyowine.org/twscalc/preference.html'>Re-Input</a>")
  ...
  print("Please check ")
  print("<a href='http://www.tokyowine.org/twscalc/result.py'>Result</a>")
